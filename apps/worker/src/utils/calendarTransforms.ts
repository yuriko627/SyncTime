...
export function transformGoogleEventToTonk(
  ...
  console.log("transformGoogleEventToTonk")
  ...
  const internalId = `${sourceCalendarId}_${
    googleEvent.id || Math.random().toString(36).substring(2, 15)
  }`
...
export function transformGoogleEventsToTonk(
  ...
  console.log("transformGoogleEventsToTonk")
  return googleEvents.map((event) =>
    transformGoogleEventToTonk(
      event,
      sourceCalendarId,
      calendarName,
      importedBy
 ...
 */
export function eventsToDocumentFormat(
  events: TonkScheduleEvent[]
): Record<string, TonkScheduleEvent> {
  console.log("eventsToDocumentFormat")
 ...
 */
export function documentFormatToEvents(
  eventsRecord: Record<string, TonkScheduleEvent>
): TonkScheduleEvent[] {
  console.log("documentFormatToEvents")
...
export function filterEventsByDateRange(
  ...
  console.log("filterEventsByDateRange")
...
export function sortEventsByStartTime(
  ...
  console.log("sortEventsByStartTime")
...
export function generateEventsSummary(events: TonkScheduleEvent[]): {
  ...
  console.log("generateEventsSummary")
  return {
    total: events.length,
...
export function transformGoogleEventsToScheduleBlocks(
  ...
  console.log("transformGoogleEventsToScheduleBlocks")
 ...
 */
function generatePrivacyPreservingBlockId(
  googleEvent: GoogleCalendarEvent,
  participantId: string
): string {
  console.log("generatePrivacyPreservingBlockId")
...
export function scheduleBlocksToDocumentFormat(
  ...
  console.log("scheduleBlocksToDocumentFormat")
  return scheduleBlocks.reduce((acc, block, index) => {
    ...
    const blockId = `${participantId}-${
      googleEvent
        ? generatePrivacyPreservingBlockId(googleEvent, participantId)
 ...
 */
export function documentFormatToScheduleBlocks(
  blocksRecord: Record<string, ScheduleBlock>
): ScheduleBlock[] {
  console.log("documentFormatToScheduleBlocks")
...
export function filterScheduleBlocksByDateRange(
  ...
  console.log("filterScheduleBlocksByDateRange")
  const start = new Date(startDate)
  const end = new Date(endDate)
